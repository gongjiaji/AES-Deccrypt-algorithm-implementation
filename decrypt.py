...
def dec_decrypt_byte_as_nibbles(nibble_quadruple, key_quadruple):
    ...
    block = dec_xor(nibble_quadruple, key_quadruple)
    block = dec_swap_last_two(block)
    block = dec_s_box(block)
    block = dec_xor(block, key_quadruple)
    block = dec_subtract_last_two_first_two(block)
    block = dec_swap_last_two(block)
    block = dec_s_box(block)
    block = dec_xor(block, key_quadruple)
